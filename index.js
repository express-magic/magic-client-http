...
var each = require("magic-client-utils").each;
...
},{"is":2,"magic-client-utils":3}],2:[function(require,module,exports){
...
var dom = _interopRequire(require("magic-client-dom"));
...
function frameGet(url) {
  ...
  dom["class"].add(frameContainer, "hidden");
  frame.src = url;
